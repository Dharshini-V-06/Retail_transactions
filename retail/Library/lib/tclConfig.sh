...
# installed.
TCL_PREFIX='D:/Retail_transaction/retail\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Retail_transaction/retail\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Retail_transaction/retail\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Retail_transaction/retail\Library\include'
...
TCL_PACKAGE_PATH='D:/Retail_transaction/retail\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Retail_transaction/retail\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Retail_transaction/retail\Library\lib\tclstub86.lib'
